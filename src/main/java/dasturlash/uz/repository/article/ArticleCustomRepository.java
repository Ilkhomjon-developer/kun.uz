...
import dasturlash.uz.dto.article.FilterResultDTO;
...
public class ArticleCustomRepository {
    ...
    public FilterResultDTO<Object[]> filter(ArticleFilterDTO filter, int page, int size, Boolean isModerator) {
        ...
        if (filter.getCreatedDateTo() != null && filter.getCreatedDateFrom() != null) {
            ...
            params.put("createdDateFrom", LocalDateTime.of(LocalDate.from(filter.getCreatedDateFrom()), LocalTime.MIN));
            params.put("createdDateTo", LocalDateTime.of(LocalDate.from(filter.getCreatedDateTo()), LocalTime.MAX));
            ...
            params.put("publishedDate", LocalDateTime.of(LocalDate.from(filter.getCreatedDateTo()), LocalTime.MAX));
        }
